...
struct Logger
{
    ...
    void (*Debug)(PluginHandle aHandle, const wchar_t* aMessage);
    ...
    void (*Info)(PluginHandle aHandle, const wchar_t* aMessage);
    ...
    void (*Warn)(PluginHandle aHandle, const wchar_t* aMessage);
    ...
    void (*Error)(PluginHandle aHandle, const wchar_t* aMessage);
    ...
    void (*Critical)(PluginHandle aHandle, const wchar_t* aMessage);
