...
RED4EXT_ASSERT_SIZE(RoachRaceObstacleTexturePartPair_Record, 0x60);
} // namespace game::data
using gamedataRoachRaceObstacleTexturePartPair_Record = game::data::RoachRaceObstacleTexturePartPair_Record;
