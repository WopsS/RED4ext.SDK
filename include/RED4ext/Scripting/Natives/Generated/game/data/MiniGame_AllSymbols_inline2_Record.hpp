...
RED4EXT_ASSERT_SIZE(MiniGame_AllSymbols_inline2_Record, 0x70);
} // namespace game::data
using gamedataMiniGame_AllSymbols_inline2_Record = game::data::MiniGame_AllSymbols_inline2_Record;
