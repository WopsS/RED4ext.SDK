...
RED4EXT_ASSERT_SIZE(AISubActionForceHitReaction_Record, 0xB8);
} // namespace game::data
using gamedataAISubActionForceHitReaction_Record = game::data::AISubActionForceHitReaction_Record;
