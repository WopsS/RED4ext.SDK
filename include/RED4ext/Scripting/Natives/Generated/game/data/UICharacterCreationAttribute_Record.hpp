...
RED4EXT_ASSERT_SIZE(UICharacterCreationAttribute_Record, 0x88);
} // namespace game::data
using gamedataUICharacterCreationAttribute_Record = game::data::UICharacterCreationAttribute_Record;
