...
RED4EXT_ASSERT_SIZE(OwnerThreatCoverSelectionParameters_Record, 0x70);
} // namespace game::data
using gamedataOwnerThreatCoverSelectionParameters_Record = game::data::OwnerThreatCoverSelectionParameters_Record;
