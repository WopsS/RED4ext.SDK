...
RED4EXT_ASSERT_SIZE(AISubActionFailIfFriendlyFire_Record, 0x60);
} // namespace game::data
using gamedataAISubActionFailIfFriendlyFire_Record = game::data::AISubActionFailIfFriendlyFire_Record;
